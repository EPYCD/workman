...
type TaskListQueryParams struct {
	...
	Expand             []string `query:"expand,explode" enum:"subtasks,buckets,reactions,comments,comment_count,time_entries_count,is_unread,scope,leases" doc:"Embed extra, more expensive data per task. Repeatable."`
